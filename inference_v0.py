"""
inference_v0.py — v0: UNet (no attention)
...
from v0Model import UNet  # v0: plain UNet
...
model = UNet(filters=64, attn=False).to(device)
...
labels = ["With twin image", "Inference — v0 UNet"]

title = "Phase-only"
save_figure(images, labels, title, f"{OUT}/result_v0.png")
