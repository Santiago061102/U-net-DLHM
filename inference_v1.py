"""
inference_v1.py — v1: Attention-Based UNet
...
from v1Model import UNet  # v1: Attention-Based UNet

# ---------------------------------------------------------------------------
# CONFIG — edit these paths before running
# ---------------------------------------------------------------------------

MODEL = r"C:\Users\santi\Desktop\Resultados\other_models\v1 Attention-Based UNet.pt"
...
print("Model: v1 — Attention-Based UNet")
...
labels = ["With twin image", "Inference — v1 Attention UNet"]

title = "Phase-only"
save_figure(images, labels, title, f"{OUT}/result_v1.png")
